   ...
   ?>
      ...
      <aside id="sidebar" class="sidebar">
         ...
         <li class="nav-item">
            ...
            <li class="nav-item"> <a class="nav-link " href="customers.php"> <i class="bi bi-people"></i> <span>Customers</span> </a></li>
...
<div class="card-title"><h3><strong>Enter Customer Details</strong></h3></div>
        ...
        <form class="row g-2 needs-validation" method="POST" id="save_cus_form" novalidate>
         <div class="col">
            <label for="cus_fname" class="form-label"><strong>First Name</strong></label>
            <input type="text" class="form-control" id="cus_fname" placeholder="First Name" name="cus_fname" required>
        </div>

        <div class="col">
         <label for="cus_lname" class="form-label"><strong>Last Name</strong></label>
            <input type="text" class="form-control" id="cus_lname"  placeholder="Last Name" name="cus_lname" required>
    </div>

    <div class="col">
         <label for="cus_num" class="form-label"><strong>Contact No.</strong></label>
            <input type="text" class="form-control" id="cus_num" placeholder="Phone Number" name="cus_num" required>
     </div>
     <div class="my-2 mb-3">
            ...
            <input type="checkbox" name="cus_delete_id[]" id="cusbox" onclick="enable()" value="<?= $rows['customer_id']; ?>">
                 ...
                 <td class="table-primary">
                   <button class="btn btn-warning">
                        <a class="text-dark" type="submit" href="editcus.php?editid=<?php echo htmlentities($rows['customer_id']);?>">
                        Edit
                        </a>
                    </button>
                 </td>
